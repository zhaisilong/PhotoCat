...
cat = df['cat_class']
base = df['base_class']
additive = df['additive_class']
solvent = df['solvent_class']
...
source = df.apply(lambda row: repr(RXN(row['canonized_rxns'])).split('>>')[0] +
                              '>' +
                              class2str(row['cat_class']) + '.' +
                              class2str(row['base_class']) + '.' +
                              class2str(row['additive_class']) + '.' +
                              class2str(row['solvent_class']) +
                              '>', axis=1)
